...
class CustomTextField: UITextField {
    // MARK: - IBInspectable
    var tintCol: UIColor = UIColor(netHex: 0x707070)
    var fontCol: UIColor = UIColor(netHex: 0x707070)
    var shadowCol: UIColor = UIColor(netHex: 0x707070)
    ...
    override func draw(_ rect: CGRect) {
        ...
        if let phText = self.placeholder {
            self.attributedPlaceholder = NSAttributedString(string: phText,
                                                            attributes: [
                                                                NSAttributedString.Key.foregroundColor: UIColor(netHex: 0xB3B3B3)
                                                            ])
        }
